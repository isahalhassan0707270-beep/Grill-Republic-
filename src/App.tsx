...
export default function App() {
  ...
  useEffect(() => {
    try {
      const raw = localStorage.getItem("grill_republic_orders");
      if (raw) {
  ...
  const getWhatsAppURL = () => {
    if (cart.length === 0) {
      ...
      return `https://wa.me/${WHATSAPP_NUMBER.replace("+", "")}?text=Hello%20Grill%20Republic!%20I'd%20like%20to%20view%20the%20active%20menu%20and%20order%20some%20smoky%2520hot%2520grills.`;
    }

    let message = `🔥 *NEW GRILL REPUBLIC ORDER* 🔥\n\n`;
  ...
  const logOrderToHistory = () => {
    ...
    localStorage.setItem("grill_republic_orders", JSON.stringify(updatedHistory));
  };
  ...
  const clearAllHistory = () => {
    if (confirm("Are you sure you want to clear your entire Grill Republic order history?")) {
      setOrderHistory([]);
      localStorage.removeItem("grill_republic_orders");
    }
  };
  ...
  const deleteHistoryItem = (id: string, e: React.MouseEvent) => {
    ...
    localStorage.setItem("grill_republic_orders", JSON.stringify(updated));
  };
          ...
          <a id="nav-logo" href="#hero" className="flex items-center space-x-2 text-white group">
            ...
            <div className="leading-tight">
              <span className="font-display text-2xl tracking-wider block font-bold text-white group-hover:text-brand-orange transition-colors duration-200">
                GRILL <span className="text-brand-orange">REPUBLIC</span>
              </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 order-1 lg:order-2">
              ...
              <div className="space-y-4 text-zinc-300 font-light leading-relaxed text-sm sm:text-base">
                <p>
                  At <strong className="text-white font-medium">Grill Republic</strong>, we don’t just host flame. We capture culinary culture. Our mission is centered on raw, authentic heat. No shortcuts, no pre-cooked reheated disappointment, and absolutely no compromises.
                </p>
                <p>
              ...
              <div className="p-5 bg-brand-black/40 rounded-xl border border-zinc-800 flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-zinc-400 text-xs mt-1">
                    &quot;Grilled to absolute perfection. Delivered sizzling hot in secure, clean food bags. If it isn't dripping with genuine smoky sureness, it isn't Grill Republic.&quot;
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-brand-black/40 border border-zinc-850 p-8 rounded-2xl flex flex-col justify-between hover:border-zinc-800 transition-colors">
              <div className="space-y-4">
                ...
                <p className="text-zinc-300 font-light italic text-sm leading-relaxed">
                  &quot;Grill Republic chicken is exceptionally juicy. My office orders 10 portions every Friday. Delivery is fast and matches the temperature of food directly taken off the wood coal. Highly recommended!&quot;
                </p>
              </div>
              <div className="flex items-center space-x-3 mt-6 pt-6 border-t border-zinc-850">
            ...
            <div className="bg-brand-black/40 border border-zinc-850 p-8 rounded-2xl flex flex-col justify-between hover:border-zinc-800 transition-colors">
              <div className="space-y-4">
                ...
                <p className="text-zinc-300 font-light italic text-sm leading-relaxed">
                  &quot;I selected the Suya Hazard spice level and it literally hit different. Crazy spice warmth with amazing smoky sweetness. Side plantain was tender too. Grill Republic holds the surefire crown.&quot;
                </p>
              </div>
              <div className="flex items-center space-x-3 mt-6 pt-6 border-t border-zinc-850">
                <div className="w-10 h-10 bg-brand-orange/10 border border-brand-orange/20 rounded-full flex items-center justify-center text-brand-orange font-bold text-xs">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center text-zinc-650 border-t border-white/5 pt-6 space-y-4 sm:space-y-0">
            ...
            <p className="text-[10px]">
              &copy; {new Date().getFullYear()} Grill Republic. All charcoal rights reserved. Lagos, Nigeria.
            </p>
